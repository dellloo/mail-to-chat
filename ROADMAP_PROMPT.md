...
**Produkt:** Chrome Extension (MV3) + Firefox (MV2). Monorepo: `packages/core`, `packages/ui`, `packages/adapters/gmail`, `apps/chrome-ext`, `apps/firefox-ext`. TypeScript strict, esbuild, Vitest (136 Tests).

**Aktuell stabile Version:** v1.11.0
...
- Alle Änderungen müssen `npm run build` + `npx vitest run` (136/136) bestehen.
